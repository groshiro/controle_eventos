...
<head>
    ...
    <style>
        ...
        tbody tr:hover td {
            background-color: rgba(233, 247, 255, 0.95) !important;
            cursor: pointer;
        }
        ...
        .header {
            ...
            backdrop-filter: blur(10px);
            border-bottom: 3px solid #e02810;
            margin-bottom: 30px;
        }
...
<body>
    ...
    <nav style="text-align: center; margin-bottom: 20px; display: flex; justify-content: center; gap: 10px;">
        <?php
        // Usamos um nome diferente (arquivo_no_servidor) para não conflitar com a $pagina_atual da tabela
        $arquivo_no_servidor = basename($_SERVER['PHP_SELF']);
        ?>
